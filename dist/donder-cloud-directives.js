 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var dt;null===(dt=window.HTMLSlotElement)||void 0===dt||dt.prototype.assignedElements;let ht=class extends st{setConfig(t){this._config=t}static get styles(){return o`
      ha-form {
        padding: 16px;
      }
    ...
    `}_showError(t){const e=document.createElement("hui-error-card");return e.setConfig({type:"error",error:t,origConfig:this.config}),T`
      ${e}
    `}_getStatusCounts(){return this.directives.reduce(((t,e)=>(t[e.status]++,t)),{success:0,warning:0,error:0})}_openDialog(){const t=new ut;t.setConfig(this.hass,this.directives),t.show()}static get styles(){return o`
