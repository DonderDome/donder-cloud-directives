 ...
 */var ct,lt,dt;null===(ct=window.HTMLSlotElement)||void 0===ct||ct.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(lt||(lt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(dt||(dt={}));var ht=["closed","locked","off"],ut=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n},pt=function(t){ut(window,"haptic",t)},vt=function(t,e,i,s){if(s||(s={action:"more-info"}),!s.confirmation||s.confirmation.exemptions&&s.confirmation.exemptions.some((function(t){return t.user===e.user.id}))||(pt("warning"),confirm(s.confirmation.text||"Are you sure you want to "+s.action+"?")))switch(s.action){case"more-info":(i.entity||i.camera_image)&&ut(t,"hass-more-info",{entityId:i.entity?i.entity:i.camera_image});break;case"navigate":s.navigation_path&&function(t,e,i){void 0===i&&(i=!1),i?history.replaceState(null,"",e):history.pushState(null,"",e),ut(window,"location-changed",{replace:i})}(0,s.navigation_path);break;case"url":s.url_path&&window.open(s.url_path);break;case"toggle":i.entity&&(function(t,e){(function(t,e,i){void 0===i&&(i=!0);var s,n=function(t){return t.substr(0,t.indexOf("."))}(e),o="group"===n?"homeassistant":n;switch(n){case"lock":s=i?"unlock":"lock";break;case"cover":s=i?"open_cover":"close_cover";break;default:s=i?"turn_on":"turn_off"}t.callService(o,s,{entity_id:e})})(t,e,ht.includes(t.states[e].state))}(e,i.entity),pt("success"));break;case"call-service":if(!s.service)return void pt("failure");var n=s.service.split(".",2);e.callService(n[0],n[1],s.service_data,s.target),pt("success");break;case"fire-dom-event":ut(t,"ll-custom",s)}};function gt(t){return void 0!==t&&"none"!==t.action}function ft(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}let _t=class extends nt{constructor(){super(...arguments),this._config={type:"donder-cloud-directives",name:"",entities:[]},this._hass={}}set hass(t){this._hass=t}get hass(){return this._hass}set config(t){this._config=t}get config(){return this._config}setConfig(t){this._config=t}static get styles(){return r`
    ...
    `}_updateDirectivesFromSensor(){if(!this.config.entities||0===this.config.entities.length)return;const t=this.hass.states[this.config.entities[0]];t&&t.attributes.directives&&(this.directives=t.attributes.directives)}firstUpdated(){this._updateDirectivesFromSensor()}render(){return this.config.show_warning?this._showWarning("warning message"):this.config.show_error?this._showError("error message"):L`
      <ha-card
