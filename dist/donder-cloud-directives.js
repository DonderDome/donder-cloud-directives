 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var ct,lt,ht;function dt(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}null===(ct=window.HTMLSlotElement)||void 0===ct||ct.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(lt||(lt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ht||(ht={}));let ut=class extends rt{constructor(){super(...arguments),this._config={type:"donder-cloud-directives",name:"",entities:[]},this._hass={}}set hass(t){this._hass=t}get hass(){return this._hass}set config(t){this._config=t}get config(){return this._config}setConfig(t){this._config=t}static get styles(){return o`
      ha-form {
        padding: 16px;
      }
    ...
    `:I``}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target;if(!e.hasAttribute("configValue"))return;const i=e.getAttribute("configValue"),s=e.value;this._config[i]!==s&&(this._config=Object.assign(Object.assign({},this._config),{[i]:s}),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}};ut=t([(t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){customElements.define(t,e)}}})(t,e))("donder-cloud-directives-editor")],ut),console.info("%c  DONDER-CLOUD-DIRECTIVES \n%c  version: 1.0.15  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"donder-cloud-directives",name:"Donder Cloud Directives",description:"A custom card for managing directives"});class pt extends rt{constructor(){super(...arguments),this.directives=[],this.newDirectiveMessage="",this.editingDirective=null,this.deletingDirectiveId=null}static async getConfigElement(){return document.createElement("donder-cloud-directives-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error("Invalid configuration");t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign(Object.assign({},t),{name:"Donder Cloud Directives",entity:"sensor.donder_directives"})}shouldUpdate(t){return!!this.config&&(console.log("shouldUpdate",t,this._hasConfigOrEntityChanged(this,t,!1),dt(this,t,!1)),this._hasConfigOrEntityChanged(this,t,!1)||dt(this,t,!1))}_hasConfigOrEntityChanged(t,e,i){if(e.has("config")||i)return!0;const s=e.get("hass");if(s&&this.config.entity){return s.states[this.config.entity].state!==t.hass.states[this.config.entity].state}return!1}_showWarning(t){return I`
    ...
    `)}}t([at()],pt.prototype,"hass",void 0),t([at()],pt.prototype,"config",void 0),t([at()],pt.prototype,"directives",void 0),t([at()],pt.prototype,"newDirectiveMessage",void 0),t([at()],pt.prototype,"editingDirective",void 0),t([at()],pt.prototype,"deletingDirectiveId",void 0),customElements.define("donder-cloud-directives",pt);export{pt as BoilerplateCard};
