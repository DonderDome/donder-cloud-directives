 ...
 */var ct,dt,ht;function ut(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}null===(ct=window.HTMLSlotElement)||void 0===ct||ct.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(dt||(dt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ht||(ht={}));let pt=class extends nt{setConfig(t){this._config=t}static get styles(){return o`
    ...
    `}render(){return this.hass&&this._config?I`
      ...
      ></ha-form>
    `:I``}_valueChanged(t){const e=t.detail.value;e&&(this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e}})))}};t([at({attribute:!1})],pt.prototype,"hass",void 0),t([lt()],pt.prototype,"_config",void 0),pt=t([(t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){customElements.define(t,e)}}})(t,e))("donder-cloud-directives-editor")],pt);class vt extends nt{constructor(){super(...arguments),this.directives=[],this.deletingDirectiveId=null,this.isDeleting=!1,this.isCreating=!1,this.newDirectiveMessage="",this._isRendered=!1}setConfig(t,e){this.config={type:"donder-cloud-directives-dialog",name:"Donder Cloud Directives",entity:"sensor.donder_directives"},this.hass=t,this.directives=e}shouldUpdate(t){return this._hasConfigOrEntityChanged(this,t,!1)||ut(this,t,!1)}_hasConfigOrEntityChanged(t,e,i){if(e.has("config")||i)return!0;const s=e.get("hass");if(s&&this.config.entity){return s.states[this.config.entity].state!==t.hass.states[this.config.entity].state}return!1}async _createDirective(){if(!this.isDeleting&&!this.isCreating)if(this.newDirectiveMessage.trim())try{const t=await this.hass.callWS({type:"donder_cloud/create_directive",message:this.newDirectiveMessage.trim()});this.isCreating=!0,t.success&&(this.isCreating=!1,this.directives=t.directives,this.newDirectiveMessage="",this._showNotification("Directive created successfully","success"))}catch(t){console.error("Error creating directive:",t),this.isCreating=!1,this._showNotification("Error creating directive","error")}else this._showNotification("Please enter a directive message","warning")}async _deleteDirective(t){if(!this.isDeleting&&!this.isCreating)try{const e=await this.hass.callWS({type:"donder_cloud/delete_directive",directive_id:t});this.isDeleting=!0,e.success&&(this.deletingDirectiveId=null,this._showNotification("Directive deleted successfully","success"),this.isDeleting=!1)}catch(t){console.error("Error deleting directive:",t),this._showNotification("Error deleting directive","error"),this.isDeleting=!1}}_showNotification(t,e){this.hass.callService("persistent_notification","create",{title:"Donder Cloud",message:t,notification_id:`donder_cloud_${e}`})}_getStatusIcon(t,e){if(this.deletingDirectiveId===e&&this.isDeleting)return"mdi:loading";switch(t){case"success":return"mdi:check-all";case"warning":return"mdi:alert-circle";default:return"mdi:help-circle"}}_getStatusClass(t,e){if(this.deletingDirectiveId===e&&this.isDeleting)return"status-loading";switch(t){case"success":return"status-success";case"warning":return"status-warning";default:return"status-unknown"}}static get styles(){return o`
      :host {
        display: block;
        padding: 16px;
        max-width: 600px;
                  ...
                  <div class="directive-content">
                    <div class="directive-status-icon">
                      <ha-icon
                        ...
                        class=${this._getStatusClass(e.status,e.id)}
                      ></ha-icon>
                    </div>
